            ...
            <v-list dense>
              <v-list-item dense>
                    <v-row>
                      ...
                      <v-col cols="11">
                        <v-btn-toggle color="primary" multiple v-model="sundayTimes">
...
export default {
  ...
  methods: {
    ...
    update(){
      ...
      this.editableUser.timetable.pn = convertValuesForWeekday(this.weekdayTimes[0].times)
      this.editableUser.timetable.vt = convertValuesForWeekday(this.weekdayTimes[1].times)
      this.editableUser.timetable.sr = convertValuesForWeekday(this.weekdayTimes[2].times)
